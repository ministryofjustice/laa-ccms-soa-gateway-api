 ...
 * specifically focuses on retrieving contract details based on certain search criteria. Service
...
public class ContractDetailsClientImpl extends AbstractSoaClient implements ContractDetailsClient {
  ...
  public ContractDetailsInqRS getContractDetails(
    ...
    ContractDetailsInqRQ.SearchCriteria searchCriteria =
        CASE_FACTORY.createContractDetailsInqRQSearchCriteria();
    ...
    JAXBElement<ContractDetailsInqRS> response =
        (JAXBElement<ContractDetailsInqRS>)
