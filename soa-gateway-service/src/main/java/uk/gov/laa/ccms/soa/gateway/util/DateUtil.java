 ...
 *
 * <p>Provides functions for converting between common date types like {@link Date} and {@link
...
public class DateUtil {
   ...
   *
   * <p>If the provided date is null, the function returns null. Otherwise, it returns an {@link
   * XMLGregorianCalendar} without time-related fields.
   *
   * @param date The {@link Date} object to be converted.
   * @return A date in {@link XMLGregorianCalendar} format containing only year, month, and day, or
   *     null if the input date is null.
   * @throws DatatypeConfigurationException If there is an exception during the date conversion.
   */
  public static XMLGregorianCalendar convertDateToXmlDateOnly(final Date date)
