...
public interface CaseDetailsMapper {
    ...
    ApplicationDetails toApplicationDetails(
        uk.gov.legalservices.ccms.casemanagement._case._1_0.casebio.ApplicationDetails soaApplicationDetails);
    ...
    @Mapping(target = "scopeLimitations", source = "proceedingDetails.scopeLimitations.scopeLimitation")
    ...
    RecordHistory toRecordHistory(uk.gov.legalservices.enterprise.common._1_0.common.RecordHistory soaRecordHistory);
