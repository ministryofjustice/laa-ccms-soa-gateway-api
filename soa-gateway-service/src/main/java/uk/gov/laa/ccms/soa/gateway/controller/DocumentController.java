 ...
 *
 * <p>Acts as an implementation of the {@link DocumentsApi}, utilizing the {@link DocumentService}
 * to register, upload and fetch relevant document data.
 */
@RestController
...
public class DocumentController implements DocumentsApi {
   ...
   *
   * @param documentId (required) - the registered id of the document to download the cover sheet
   *     for.
   * @param soaGatewayUserLoginId (required) - the user requesting the data.
   * @param soaGatewayUserRole (required) - the user role requesting the data.
   ...
   */
  @Override
  public ResponseEntity<CoverSheet> downloadDocumentCoverSheet(
      String documentId, String soaGatewayUserLoginId, String soaGatewayUserRole) {
