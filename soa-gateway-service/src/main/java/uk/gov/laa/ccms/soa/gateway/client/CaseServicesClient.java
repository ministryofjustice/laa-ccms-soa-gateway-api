 ...
 * based on search criteria provided. Service name and URL details are injected at runtime.
 */
@Slf4j
...
public class CaseServicesClient extends AbstractSoaClient {
  ...
  public CaseInqRS getCaseDetails(
      String loggedInUserId, String loggedInUserType, Integer maxRecords, CaseInfo caseInfo) {
  ...
  public CaseAddRS createCaseApplication(
      String loggedInUserId, String loggedInUserType, CaseAdd caseAdd) {
