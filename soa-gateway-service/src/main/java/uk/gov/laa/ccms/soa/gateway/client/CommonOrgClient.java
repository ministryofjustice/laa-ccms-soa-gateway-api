 ...
 * specifically focuses on common organisation services. It provides facilities for retrieving
 * organisation details based on search criteria provided. Service name and URL details are injected
 * at runtime.
 */
@Slf4j
...
public class CommonOrgClient extends AbstractSoaClient {
  ...
  public CommonOrgInqRS getOrganisations(
    ...
    CommonOrgInqRQ.SearchCriteria searchCriteria =
        COMMONORG_FACTORY.createCommonOrgInqRQSearchCriteria();
