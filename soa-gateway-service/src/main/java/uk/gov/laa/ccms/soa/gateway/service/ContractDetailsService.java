...
public class ContractDetailsService {
   ...
   *
   * <p>This method communicates with the Contract Details system to fetch specific contract
   * details using provided search criteria. It uses the search firm ID and search office ID
   * along with user credentials and other optional parameters to narrow down the search
   * results.</p>
   *
   ...
   * @return                       A {@link ContractDetails} object containing the details of the
