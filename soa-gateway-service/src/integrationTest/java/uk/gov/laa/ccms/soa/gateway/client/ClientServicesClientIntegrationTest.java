...
public class ClientServicesClientIntegrationTest {
  ...
  @Autowired private ClientServicesClient client;
  ...
  private static final String MSG_NS =
      "http://legalservices.gov.uk/CCMS/ClientManagement/Client/1.0/ClientBIM";
  private static final String CLIENT_NS =
      "http://legalservices.gov.uk/CCMS/ClientManagement/Client/1.0/ClientBIO";
  ...
  public void testGetClientDetails_ReturnsData() throws Exception {
    ...
    mockServer
        .expect(
            xpath("/msg:ClientInqRQ/header:HeaderRQ/header:TransactionRequestID", namespaces)
                .exists())
        .andExpect(
            xpath("/msg:ClientInqRQ/header:HeaderRQ/header:UserLoginID", namespaces)
                .evaluatesTo(testLoginId))
        .andExpect(
            xpath("/msg:ClientInqRQ/header:HeaderRQ/header:UserRole", namespaces)
                .evaluatesTo(testUserType))
        .andExpect(
            xpath("/msg:ClientInqRQ/msg:SearchCriteria/msg:ClientInfo/client:FirstName", namespaces)
                .evaluatesTo(firstName))
        .andExpect(
            xpath("/msg:ClientInqRQ/msg:SearchCriteria/msg:ClientInfo/client:Surname", namespaces)
                .evaluatesTo(surname))
        .andRespond(withPayload(clientInqRS_valid));

    ClientInqRS response =
        client.getClientDetails(testLoginId, testUserType, maxRecords, clientInfo);
    ...
    mockServer
        ...
        .andExpect(
            xpath("/msg:ClientInqRQ/header:HeaderRQ/header:UserRole", namespaces)
                .evaluatesTo(testUserType))
        .andExpect(
            xpath("/msg:ClientInqRQ/msg:SearchCriteria/msg:ClientReferenceNumber", namespaces)
                .evaluatesTo(clientReferenceNumber))
        .andRespond(withPayload(clientInqRS_valid_one));

    ClientInqRS response =
        client.getClientDetail(testLoginId, testUserType, maxRecords, clientReferenceNumber);
  ...
  public void testPostClient_ReturnsData() throws IOException, DatatypeConfigurationException {
    ...
    mockServer
        .expect(
            xpath("/msg:ClientAddRQ/header:HeaderRQ/header:TransactionRequestID", namespaces)
                .exists())
        .andExpect(
            xpath("/msg:ClientAddRQ/header:HeaderRQ/header:UserLoginID", namespaces)
                .evaluatesTo(testLoginId))
        .andExpect(
            xpath("/msg:ClientAddRQ/header:HeaderRQ/header:UserRole", namespaces)
                .evaluatesTo(testUserType))
        .andExpect(
            xpath("/msg:ClientAddRQ/msg:Client/client:Name/common:Surname", namespaces)
                .evaluatesTo(surname))
        .andExpect(
            xpath("/msg:ClientAddRQ/msg:Client/client:Name/common:FirstName", namespaces)
                .evaluatesTo(firstName))
        .andExpect(
            xpath("/msg:ClientAddRQ/msg:Client/client:Name/common:SurnameAtBirth", namespaces)
                .evaluatesTo(surname))
        .andExpect(
            xpath("/msg:ClientAddRQ/msg:Client/client:Address/common:House", namespaces)
                .evaluatesTo(houseNumber))
        .andExpect(
            xpath("/msg:ClientAddRQ/msg:Client/client:Address/common:AddressLine1", namespaces)
                .evaluatesTo(addressLine1))
        .andExpect(
            xpath("/msg:ClientAddRQ/msg:Client/client:Address/common:City", namespaces)
                .evaluatesTo(city))
        .andExpect(
            xpath("/msg:ClientAddRQ/msg:Client/client:Address/common:Country", namespaces)
                .evaluatesTo(country))
        .andExpect(
            xpath("/msg:ClientAddRQ/msg:Client/client:Address/common:PostalCode", namespaces)
                .evaluatesTo(postcode))
        .andExpect(
            xpath(
                    "/msg:ClientAddRQ/msg:Client/client:PersonalInformation/client:DateOfBirth",
                    namespaces)
                .evaluatesTo(dateOfBirth))
        .andExpect(
            xpath(
                    "/msg:ClientAddRQ/msg:Client/client:PersonalInformation/client:Gender",
                    namespaces)
                .evaluatesTo(gender))
        .andExpect(
            xpath(
                    "/msg:ClientAddRQ/msg:Client/client:PersonalInformation/client:MaritalStatus",
                    namespaces)
                .evaluatesTo(maritalStatus))
        .andExpect(
            xpath(
                    "/msg:ClientAddRQ/msg:Client/client:PersonalInformation/client:VulnerableClient",
                    namespaces)
                .evaluatesTo(String.valueOf(vulnerableClient)))
        .andExpect(
            xpath(
                    "/msg:ClientAddRQ/msg:Client/client:PersonalInformation/client:HighProfileClient",
                    namespaces)
                .evaluatesTo(String.valueOf(highProfileClient)))
        .andExpect(
            xpath(
                    "/msg:ClientAddRQ/msg:Client/client:PersonalInformation/client:VexatiousLitigant",
                    namespaces)
                .evaluatesTo(String.valueOf(vexatiousLitigant)))
        .andExpect(
            xpath(
                    "/msg:ClientAddRQ/msg:Client/client:PersonalInformation/client:CountryOfOrigin",
                    namespaces)
                .evaluatesTo(countryOfOrigin))
        .andExpect(
            xpath(
                    "/msg:ClientAddRQ/msg:Client/client:PersonalInformation/client:MentalCapacityInd",
                    namespaces)
                .evaluatesTo(String.valueOf(mentalCapacityInd)))
        .andExpect(
            xpath("/msg:ClientAddRQ/msg:Client/client:Contacts/client:TelephoneHome", namespaces)
                .evaluatesTo(telephoneHome))
        .andExpect(
            xpath("/msg:ClientAddRQ/msg:Client/client:Contacts/client:Password", namespaces)
                .evaluatesTo(password))
        .andExpect(
            xpath("/msg:ClientAddRQ/msg:Client/client:Contacts/client:PasswordReminder", namespaces)
                .evaluatesTo(passwordReminder))
        .andExpect(
            xpath(
                    "/msg:ClientAddRQ/msg:Client/client:Contacts/client:CorrespondenceMethod",
                    namespaces)
                .evaluatesTo(correspondenceMethod))
  ...
  private ClientDetails buildClientDetails() throws DatatypeConfigurationException {
    ...
    XMLGregorianCalendar gregorianDateOfBirth =
        DatatypeFactory.newInstance().newXMLGregorianCalendar(dateOfBirth);
