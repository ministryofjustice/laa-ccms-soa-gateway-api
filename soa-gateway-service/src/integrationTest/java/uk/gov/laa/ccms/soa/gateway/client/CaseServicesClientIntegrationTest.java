...
public class CaseServicesClientIntegrationTest {
    ...
    public void testGetCaseDetails_ReturnsData() throws Exception {
        ...
        mockServer.expect(xpath("/msg:CaseInqRQ/header:HeaderRQ/header:TransactionRequestID", namespaces).exists())
                .andExpect(xpath("/msg:CaseInqRQ/header:HeaderRQ/header:UserLoginID", namespaces).evaluatesTo(testLoginId))
                .andExpect(xpath("/msg:CaseInqRQ/header:HeaderRQ/header:UserRole", namespaces).evaluatesTo(testUserType))
                .andExpect(xpath("/msg:CaseInqRQ/msg:SearchCriteria/msg:CaseInfo/client:CaseReferenceNumber", namespaces)
                    .evaluatesTo(caseInfo.getCaseReferenceNumber()))
                .andExpect(xpath("/msg:CaseInqRQ/msg:SearchCriteria/msg:CaseInfo/client:CaseStatus", namespaces)
