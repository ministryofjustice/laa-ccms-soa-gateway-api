...
public class ClientDetailsServiceTest {
  ...
  @Mock private ClientServicesClient clientServicesClient;
  ...
  public void testPostClient() {
    ...
    verify(clientServicesClient)
        .postClientDetails(soaGatewayUserLoginId, soaGatewayUserRole, mockClientDetails);
  }
  ...
  public void testUpdateClient() {
    ...
    verify(clientServicesClient)
        .updateClientDetails(soaGatewayUserLoginId, soaGatewayUserRole, mockClientUpdateRq);
  }
